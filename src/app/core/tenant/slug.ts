/**
 * Slug de una boda: `mariaygabriel` en `mariaygabriel.nupcialis.com`.
 *
 * Es la parte de la URL que un invitado va a leer en WhatsApp, teclear a mano y
 * dictar por teléfono. Todo lo que sigue está pensado para eso.
 */
